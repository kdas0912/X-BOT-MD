...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:ab9aa5a2b3600b394448884014e1a51d";
const SUDO = process.env.SUDO || '919832962298';
...
const BOT_INFO = process.env.BOT_INFO || "—♪♪♪ 𝐎𝐆𝐆𝐘••• ♥️🧿🌼;𝐷𝐴𝑅𝐸  𝐷𝐴𝑉𝐼𝐿 ♡⁠‿⁠♡;https://i.imgur.com/r3GZeiX.jpeg";
...
const STICKER_DATA = process.env.STICKER_DATA || "—♪♪♪ 𝐎𝐆𝐆𝐘••• ♥️🧿🌼;𝐷𝐴𝑅𝐸  𝐷𝐴𝑉𝐼𝐿 ♡⁠‿⁠♡";
